...
$id = $_GET['id'];
$dataGet = mysqli_query($conn, "SELECT * FROM kota WHERE id = '$id'");
...
if (isset($_POST['update'])) {
   ...
   $execute = mysqli_query($conn, "UPDATE kota SET nama_kota = '$nama' WHERE id = '$id'");
      ...
      <div class="container">
         ...
         <form action="edit.php?id=<?= $id ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
               <label for="nama">Nama Kota</label><br>
               <input type="text" value="<?= $data->nama_kota ?>" required name="nama" id="">
            </div>
            <div class="form-group">
