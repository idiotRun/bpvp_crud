...
$id = $_GET['id'];
$dataGet = mysqli_query($conn, "SELECT * FROM pelanggan WHERE id = '$id'");
...
if (isset($_POST['update'])) {
   ...
   $alamat = $_POST['alamat'] ?? '-';
      ...
      $execute = mysqli_query($conn, "UPDATE pelanggan SET name = '$name', no_hp = '$no_hp', alamat = '$alamat' WHERE id = '$id'");
